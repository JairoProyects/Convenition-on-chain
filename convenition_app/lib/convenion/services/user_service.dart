  ...
  final _baseUrl = ApiConfig.users;
    ...
    Future<UserModel> getUserById(String id) async {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load user with id $id. Status: ${response.statusCode}');
      }
    }
    ...
    Future<UserModel> updateUser(String id, UpdateUserDto userDto) async {
      ...
      throw Exception('Failed to update user with id $id. Status: ${response.statusCode}');
      }
    }
    ...
    Future<void> deleteUser(String id) async {
      ...
      throw Exception('Failed to delete user with id $id. Status: ${response.statusCode}');
      }
    }
